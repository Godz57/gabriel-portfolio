  ...
  return (
    <div
      className={[
        ...
        '[&_p]:leading-relaxed',
        '[&_a]:font-medium [&_a]:text-brand-fg [&_a]:underline [&_a]:underline-offset-4 [&_a]:hover:text-brand-fg-soft',
        ...
        '[&_li]:leading-relaxed',
        '[&_code]:rounded [&_code]:bg-zinc-900 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-sm [&_code]:text-brand-fg-soft',
        ...
        '[&_blockquote]:border-l-2 [&_blockquote]:border-brand/50 [&_blockquote]:pl-4 [&_blockquote]:text-zinc-400',
        '[&_hr]:border-zinc-800',
        className,
      ]
        .filter(Boolean)
