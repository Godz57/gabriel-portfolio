    ...
    <footer className="relative z-10 mt-auto border-t border-white/5 bg-zinc-950/80">
      <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-6 px-4 py-12 sm:flex-row sm:items-center sm:px-6">
        ...
        <div className="flex flex-wrap items-center gap-4 text-sm text-zinc-400">
          <Link href="/#servicos" className="hover:text-brand-fg">
            Serviços
          </Link>
          <Link href="/cases" className="hover:text-brand-fg">
            Cases
          </Link>
          <Link href="/stack" className="hover:text-brand-fg">
            Stack
          </Link>
          <Link href="/contato" className="hover:text-brand-fg">
            Contato
          </Link>
          <a
            href={githubUrl}
